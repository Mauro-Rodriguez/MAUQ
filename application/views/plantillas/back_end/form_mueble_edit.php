<div>
     <h2 style="color: #75A64F"><strong>Editar Mueble</strong></h2>
...
<div style="text-align: left">
     ...
     <?php
           ...
           */ 
          echo form_open('mueble/editarMueble');//Cuando se presiona el botón submit el ruteo es donde le indica el parametro del form_open
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php
          ...
          //Campo oculto para almacenar la variable.
          ?><input type="hidden" id="id_oculto" name="id" value="<?php echo $id?>" /> <?php
          ...
          //Boton regresar a los datos de los muebles
          $data_boton_volver = array(
               'name' => 'boton_volver',
               'id'   => 'boton_volver',
               'content' => 'Regresar',
               'style'       => 'width:10%',
          ...
          echo form_button($data_boton_volver);
...
<script>
     jQuery(document).ready(function(){
          ...
          jQuery("#boton_mueble").click(function(){
               ...
               if((nombre_mueble != "") && (ubicacion_mueble != "") && (descripcion_mueble != ""))
               {
                    //Se enviaran los datos con ajax para no recargarla pagina
                    jQuery.ajax({url:"<?php echo base_url().'mueble/editarMueble';?>",//url a donde va a ser enviada la información
                           type: 'post', //Método por el cual va a ser enviada la información
                           data:{id: id, descripcion: descripcion_mueble, nombre:nombre_mueble, ubicacion:ubicacion_mueble, url_imagen: imagen_mueble},
                           success:function(result){
                           jQuery("#mensaje").html(result);
                           }});
                           
                           jQuery("#nombre_mueble").val(nombre_mueble);
                           jQuery("#ubicacion_mueble").val(ubicacion_mueble);
                           jQuery("#descripcion_mueble").val(descripcion_mueble);
                           jQuery("#imagen_mueble").val("");
                           jQuery("#id_oculto").val(id);
          ...
          jQuery("#boton_volver").click(function(){
                          
                          window.location.href = "<?php echo base_url().'mueble/mueble_datos'?>";
          });
     });
</script>